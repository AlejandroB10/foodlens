...
export const translations = {
  en: {
    ...
    'xai.nutrient.sugars_100g': 'sugar',
    'xai.nutrient.fat_100g': 'fat',
    'xai.nutrient.saturatedFat_100g': 'saturated fat',
    'xai.nutrient.salt_100g': 'salt',
    'xai.nutrient.fiber_100g': 'fibre',
    'xai.nutrient.proteins_100g': 'protein',
    'xai.nutrient.energyKcal_100g': 'calories',
    'xai.dir.less': 'less',
    'xai.dir.more': 'more',
    'xai.cmp.better': 'better',
    'xai.cmp.worse': 'worse',
    'xai.ref.category_average': 'the category average',
    'xai.ref.usual_generic': 'your usual choice',
    'xai.ref.alternative': 'an alternative',
    'xai.no_product': 'No product to explain.',
    'xai.insufficient_data': 'Insufficient data to compare this product against a reference.',
    'xai.insufficient_comparable': 'Insufficient comparable data between this product and {ref}.',
    'xai.s.base': 'This product has {pct} {dir} {nutrient} per 100g than {ref}',
    'xai.s.suffix_nutri': ', with a {cmp} Nutri-Score ({a} vs {b}).',
    'xai.s.suffix_eco': ', with a {cmp} Environmental Score ({a} vs {b}).',
    'xai.s.nutri_only': 'This product has a {cmp} Nutri-Score than {ref} ({a} vs {b}).',
    'xai.s.eco_only': 'This product has a {cmp} Environmental Score than {ref} ({a} vs {b}).',
    'xai.delta.item': '{grams} {dir} {nutrient}',
    'xai.delta.per100g': ' per 100g.',
  ...
  es: {
    ...
    'xai.nutrient.sugars_100g': 'azúcar',
    'xai.nutrient.fat_100g': 'grasa',
    'xai.nutrient.saturatedFat_100g': 'grasa saturada',
    'xai.nutrient.salt_100g': 'sal',
    'xai.nutrient.fiber_100g': 'fibra',
    'xai.nutrient.proteins_100g': 'proteína',
    'xai.nutrient.energyKcal_100g': 'calorías',
    'xai.dir.less': 'menos',
    'xai.dir.more': 'más',
    'xai.cmp.better': 'mejor',
    'xai.cmp.worse': 'peor',
    'xai.ref.category_average': 'la media de la categoría',
    'xai.ref.usual_generic': 'tu elección habitual',
    'xai.ref.alternative': 'una alternativa',
    'xai.no_product': 'No hay producto que explicar.',
    'xai.insufficient_data': 'Datos insuficientes para comparar este producto con una referencia.',
    'xai.insufficient_comparable': 'Datos comparables insuficientes entre este producto y {ref}.',
    'xai.s.base': 'Este producto tiene un {pct} {dir} de {nutrient} por 100g que {ref}',
    'xai.s.suffix_nutri': ', con un Nutri-Score {cmp} ({a} vs {b}).',
    'xai.s.suffix_eco': ', con un Eco-Score {cmp} ({a} vs {b}).',
    'xai.s.nutri_only': 'Este producto tiene un Nutri-Score {cmp} que {ref} ({a} vs {b}).',
    'xai.s.eco_only': 'Este producto tiene un Eco-Score {cmp} que {ref} ({a} vs {b}).',
    'xai.delta.item': '{grams} {dir} de {nutrient}',
    'xai.delta.per100g': ' por 100g.',
  ...
  ca: {
    ...
    'xai.nutrient.sugars_100g': 'sucre',
    'xai.nutrient.fat_100g': 'greix',
    'xai.nutrient.saturatedFat_100g': 'greix saturat',
    'xai.nutrient.salt_100g': 'sal',
    'xai.nutrient.fiber_100g': 'fibra',
    'xai.nutrient.proteins_100g': 'proteïna',
    'xai.nutrient.energyKcal_100g': 'calories',
    'xai.dir.less': 'menys',
    'xai.dir.more': 'més',
    'xai.cmp.better': 'millor',
    'xai.cmp.worse': 'pitjor',
    'xai.ref.category_average': 'la mitjana de la categoria',
    'xai.ref.usual_generic': 'la teva opció habitual',
    'xai.ref.alternative': 'una alternativa',
    'xai.no_product': 'No hi ha cap producte per explicar.',
    'xai.insufficient_data': 'Dades insuficients per comparar aquest producte amb una referència.',
    'xai.insufficient_comparable': 'Dades comparables insuficients entre aquest producte i {ref}.',
    'xai.s.base': 'Aquest producte té un {pct} {dir} de {nutrient} per 100g que {ref}',
    'xai.s.suffix_nutri': ', amb un Nutri-Score {cmp} ({a} vs {b}).',
    'xai.s.suffix_eco': ', amb un Eco-Score {cmp} ({a} vs {b}).',
    'xai.s.nutri_only': 'Aquest producte té un Nutri-Score {cmp} que {ref} ({a} vs {b}).',
    'xai.s.eco_only': 'Aquest producte té un Eco-Score {cmp} que {ref} ({a} vs {b}).',
    'xai.delta.item': '{grams} {dir} de {nutrient}',
    'xai.delta.per100g': ' per 100g.',
