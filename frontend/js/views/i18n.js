...
export const translations = {
  en: {
    ...
    'nav.back_to_results': 'Back to results',
    'home.eyebrow': 'Two scores. One number. No lectures.',
    'home.statement': 'See a food\'s <em>Health</em> and <em>Eco</em> scores side by side, with one verifiable number explaining why.',
    'home.cta.inspect': 'Inspect a product',
    'home.cta.browse': 'Browse the shelf',
    'home.about': 'About FoodLens',
    ...
    'personas.title': 'Four ways FoodLens <em>thinks</em> about food',
    'personas.subtitle': 'Every feature is tested against four real people — not abstractions. See who we built this for.',
    ...
    'persona.p4.role': '24 · convenience-led shopper · Palma',
    'persona.p4.quote': '"Just tell me which one is the honest choice in ten seconds — I don\'t have time for a lecture."',
    'persona.p4.desc': 'Shops fast on a tight budget between school runs. Wants a quick, honest call between two options without being judged for it. FoodLens gives her both badges and one sentence at a glance — no guilt, no friction.',
    'about.title': 'About FoodLens',
    'about.intro': 'FoodLens is a course prototype that scores food on two axes — Health and Eco — and explains its reasoning in one verifiable sentence, never a lecture.',
    'about.methodology': 'The design is grounded in six WA3 interviews and a thematic analysis: five key insights and seven design hooks. Every screen is checked against the four personas above.',
    'about.eval_link': 'Evaluate the prototype',
    'about.eval_hint': 'Optional research instrument for the WA5 study — not part of the shopping flow.',
    'about.team_link': 'Meet the team',
    'about.project_link': 'Project repository',
    'footer.nav.about': 'About',
    'footer.nav.evaluate': 'Evaluate the prototype',
    'footer.attribution_short': 'Data from <a href="https://world.openfoodfacts.org" rel="noopener" target="_blank">Open Food Facts</a>. Scores reflect the official Nutri-Score and Environmental Score methodologies — we consume them, we do not recompute them.',
    'nav.compare': 'Compare',
    'header.theme': 'Switch theme',
    'compare.title': 'Compare your shelf',
    'compare.intro': 'A ranked list out, one verifiable line per product. Add items from Discover, then read them side by side.',
    'compare.back': 'Back to Discover',
    'compare.empty': 'No products selected yet. Add some from Discover to compare them here.',
    ...
    'catalogue.showing': '{loaded} of {total}',
    'ui.load_more': 'Load more',
    'ui.loading_more': 'Loading…',
  ...
  es: {
    ...
    'nav.back_to_results': 'Volver a resultados',
    'home.eyebrow': 'Dos puntuaciones. Un número. Sin sermones.',
    'home.statement': 'Mira la puntuación de <em>Salud</em> y la de <em>Eco</em> lado a lado, con un número verificable que explica por qué.',
    'home.cta.inspect': 'Inspeccionar producto',
    'home.cta.browse': 'Ver el catálogo',
    'home.about': 'Sobre FoodLens',
    'home.recent': 'Sigue donde lo dejaste',
    ...
    'personas.title': 'Cuatro formas en las que FoodLens <em>piensa</em> sobre la comida',
    'personas.subtitle': 'Cada funcionalidad se prueba con cuatro personas reales, no abstracciones. Mira para quién construimos esto.',
    ...
    'persona.p4.role': '24 · compradora orientada a la conveniencia · Palma',
    'persona.p4.quote': '"Dime cuál es la opción honesta en diez segundos; no tengo tiempo para un sermón."',
    'persona.p4.desc': 'Compra rápido y con presupuesto ajustado entre recados. Quiere una decisión rápida y honesta entre dos opciones sin que la juzguen por ello. FoodLens le da ambas insignias y una frase de un vistazo: sin culpa, sin fricción.',
    'about.title': 'Sobre FoodLens',
    'about.intro': 'FoodLens es un prototipo de asignatura que puntúa la comida en dos ejes — Salud y Eco — y explica su razonamiento en una frase verificable, nunca un sermón.',
    'about.methodology': 'El diseño se basa en seis entrevistas WA3 y un análisis temático: cinco hallazgos clave y siete anclas de diseño. Cada pantalla se contrasta con las cuatro personas de arriba.',
    'about.eval_link': 'Evaluar el prototipo',
    'about.eval_hint': 'Instrumento de investigación opcional para el estudio WA5; no forma parte del flujo de compra.',
    'about.team_link': 'Conoce al equipo',
    'about.project_link': 'Repositorio del proyecto',
    'footer.nav.about': 'Acerca de',
    'footer.nav.evaluate': 'Evaluar el prototipo',
    'footer.attribution_short': 'Datos de <a href="https://world.openfoodfacts.org" rel="noopener" target="_blank">Open Food Facts</a>. Las puntuaciones reflejan las metodologías oficiales de Nutri-Score y Eco-Score: las consumimos, no las recalculamos.',
    'nav.compare': 'Comparar',
    'header.theme': 'Cambiar tema',
    'compare.title': 'Compara tu estante',
    'compare.intro': 'Una lista ordenada como salida, una línea verificable por producto. Añade productos desde Descubrir y léelos en paralelo.',
    'compare.back': 'Volver a Descubrir',
    'compare.empty': 'Aún no has seleccionado productos. Añade algunos desde Descubrir para compararlos aquí.',
    ...
    'catalogue.load_more': 'Cargar más',
    'catalogue.loading': 'Cargando…',
    'catalogue.showing': '{loaded} de {total}',
    'ui.load_more': 'Cargar más',
    'ui.loading_more': 'Cargando…',
  ...
  ca: {
    ...
    'nav.back_to_results': 'Tornar als resultats',
    'home.eyebrow': 'Dues puntuacions. Un número. Sense sermons.',
    'home.statement': 'Mira la puntuació de <em>Salut</em> i la d\'<em>Eco</em> una al costat de l\'altra, amb un número verificable que explica per què.',
    'home.cta.inspect': 'Inspeccionar un producte',
    'home.cta.browse': 'Veure el catàleg',
    'home.about': 'Sobre FoodLens',
    'home.recent': 'Continua on ho vas deixar',
    ...
    'personas.title': 'Quatre maneres en les quals FoodLens <em>pensa</em> sobre el menjar',
    'personas.subtitle': 'Cada funcionalitat es prova amb quatre persones reals, no abstraccions. Mira per a qui construïm això.',
    ...
    'persona.p4.role': '24 · compradora orientada a la conveniència · Palma',
    'persona.p4.quote': '"Digues-me quina és l\'opció honesta en deu segons; no tinc temps per a un sermó."',
    'persona.p4.desc': 'Compra ràpid i amb pressupost ajustat entre encàrrecs. Vol una decisió ràpida i honesta entre dues opcions sense que la jutgin per això. FoodLens li dóna ambdues insígnies i una frase d\'un cop d\'ull: sense culpa, sense fricció.',
    'about.title': 'Sobre FoodLens',
    'about.intro': 'FoodLens és un prototip d\'assignatura que puntua el menjar en dos eixos — Salut i Eco — i explica el seu raonament en una frase verificable, mai un sermó.',
    'about.methodology': 'El disseny es basa en sis entrevistes WA3 i una anàlisi temàtica: cinc troballes clau i set àncores de disseny. Cada pantalla es contrasta amb les quatre persones de dalt.',
    'about.eval_link': 'Avaluar el prototip',
    'about.eval_hint': 'Instrument de recerca opcional per a l\'estudi WA5; no forma part del flux de compra.',
    'about.team_link': 'Coneix l\'equip',
    'about.project_link': 'Repositori del projecte',
    'footer.nav.about': 'Quant a',
    'footer.nav.evaluate': 'Avaluar el prototip',
    'footer.attribution_short': 'Dades d\'<a href="https://world.openfoodfacts.org" rel="noopener" target="_blank">Open Food Facts</a>. Les puntuacions reflecteixen les metodologies oficials de Nutri-Score i Eco-Score: les consumim, no les recalculem.',
    'nav.compare': 'Comparar',
    'header.theme': 'Canviar tema',
    'compare.title': 'Compara la teva prestatgeria',
    'compare.intro': 'Una llista ordenada com a sortida, una línia verificable per producte. Afegeix productes des de Descobrir i llegeix-los en paral·lel.',
    'compare.back': 'Tornar a Descobrir',
    'compare.empty': 'Encara no has seleccionat productes. Afegeix-ne alguns des de Descobrir per comparar-los aquí.',
    ...
    'catalogue.load_more': 'Carrega més',
    'catalogue.loading': 'Carregant…',
    'catalogue.showing': '{loaded} de {total}',
    'ui.load_more': 'Carrega més',
    'ui.loading_more': 'Carregant…',
...
function updateDOM(lang) {
  ...
  // 2b. aria-label translations (icon-only controls without visible text).
